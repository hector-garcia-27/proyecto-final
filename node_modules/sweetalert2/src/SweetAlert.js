import { handleCancelarButtonClick, handleConfirmButtonClick, handleDenyButtonClick } from './buttons-handlers.js'
...
const swalPromise = (instance, domCache, innerParams) => {
  return new Promise((resolve, reject) => {
    ...
    domCache.CancelarButton.onclick = () => {
      handleCancelarButtonClick(instance, dismissWith)
    }
...
const populateDomCache = (instance) => {
  const domCache = {
    ...
    CancelarButton: dom.getCancelarButton(),
 ...
 * 5. Else if `focusCancelar` is `true` and Cancelar button is visible, focus it.
...
const focusButton = (domCache, innerParams) => {
  ...
  if (innerParams.focusCancelar && dom.isVisible(domCache.CancelarButton)) {
    domCache.CancelarButton.focus()
    return true
  }
